...
public class Initialize {
    ...
    ArrayList<Restaurant> initialization() {
        ...
        HashMap<Food, Integer> menu1 = new HashMap<Food, Integer>();
        ...
        Restaurant restaurant1 = new Restaurant("choloSara","tehran,yaftAbad",new Time(11,30),
                new Time(23,59),CostLevel.ECONIMIC,menu1);
        HashMap<Food, Integer> menu2 = new HashMap<Food, Integer>();
        ...
        Restaurant restaurant2 = new Restaurant("pitzaSara", "tehran,khaniabad",
                new Time(11, 00), new Time(22, 10), CostLevel.LUXURY, menu2);
        HashMap<Food, Integer> menu3 = new HashMap<Food, Integer>();
        ...
        Restaurant restaurant3 = new Restaurant("pitzaSara", "tehran,yakhchiabad",
                new Time(12, 05), new Time(22, 35), CostLevel.NORMAL, menu3);
        HashMap<Food, Integer> menu4 = new HashMap<Food, Integer>();
        ...
        Restaurant restaurant4 = new Restaurant("lebanese Restaurant", "karaj,km 8",
                new Time(10, 45), new Time(22, 55), CostLevel.LUXURY, menu4);
        HashMap<Food, Integer> menu5 = new HashMap<Food, Integer>();
        ...
        Restaurant restaurant5 = new Restaurant("baabaataaher", "hamedan",
                new Time(5, 0), new Time(24, 0), CostLevel.ECONIMIC, menu5);
    ...
    void showRestaurant(){
        ...
        Time currentTime = new Time(22, 40);
